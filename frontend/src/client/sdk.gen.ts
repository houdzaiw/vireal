...
export class AdminAppService {
    ...
    /**
     * Read App Generations
     *
     * Retrieve App AI generation works for admin management.
     */
    public static readAppGenerations<ThrowOnError extends boolean = true>(options?: Options<adminAppReadAppGenerationsData, ThrowOnError>) {
        return (options?.client ?? client).get<adminAppReadAppGenerationsResponses, adminAppReadAppGenerationsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Delete App Generation
     *
     * Soft delete an App AI generation work.
     */
    public static deleteAppGeneration<ThrowOnError extends boolean = true>(options: Options<adminAppDeleteAppGenerationData, ThrowOnError>) {
        return (options.client ?? client).delete<adminAppDeleteAppGenerationResponses, adminAppDeleteAppGenerationErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static readAppGeneration<ThrowOnError extends boolean = true>(options: Options<adminAppReadAppGenerationData, ThrowOnError>) {
        return (options.client ?? client).get<adminAppReadAppGenerationResponses, adminAppReadAppGenerationErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/api/v1/admin/app/generations/{generation_id}',
            ...options
